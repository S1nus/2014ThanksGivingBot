...
import edu.wpi.first.wpilibj.templates.subsystems.MecanumDrive;
import edu.wpi.first.wpilibj.templates.subsystems.AirCannon;
import edu.wpi.first.wpilibj.templates.subsystems.Pitch;
import edu.wpi.first.wpilibj.templates.subsystems.Compressors;
/**
...
public abstract class CommandBase extends Command {
    ...
    public static Compressors compressors = new Compressors();
